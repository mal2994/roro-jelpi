...
-- GPIO is 128 bytes, cartdata is 256 bytes
-- I THINK the format is similar to the gfx format -- nibbles are written in the blob.
--  example:  hexidecimal 1A is decimal 26.
if false then
...
-- set the flag false to do normal jelpi gameplay
